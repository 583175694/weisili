var Scratch = (function() {
	...
	var Scratch = function(options) {
		...
		this.defaults = {
			...
			sceneWidth: 454, // Canvas width
			sceneHeight: 454, // Canvas height
	...
	Scratch.prototype.scratch = function(e) {
		...
		// var x = position.x - this.zone.left + 110;
		// var y = position.y - this.zone.top + window.pageYOffset + 110;
		var x = position.x - this.zone.left + 20;
		var y = position.y - this.zone.top - 150;
		var i = 0;
